...
public interface CustomerServiceInterface {
   ...
   /**
    * Finds all customers such that the value of filed with name given by
    * fieldName is equal to given value.
    * 
    * @param fieldName
    * @param value
    * @return
   ...
   /**
    * Calculates the average of total order costs per client, i.e. for each
    * client will add up all prices of orders and average this over all clients
    * (add and divide over the number of clients). The includeEmpty parameter
    * controls if clients with empty order lists should be included in this or
    * not.
    * 
    * @param includeEmpty
    * @return
    ...
    * This returns a list, since few products could have the same number of
    * buys.
    * 
    * @return
    */
